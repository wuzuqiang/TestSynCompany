...
namespace BaseClassUtils.SimuLinq
{
    ...
    {
        public static Exception ArgumentNull(string errorMsg)
        {
            return new Exception(errorMsg);
        }
        public static Exception NoElements() { return new Exception("	NoElements	"); }
        public static Exception NoMatch() { return new Exception("	NoMatch	"); }
        public static Exception MoreThanOneElement() { return new Exception("	MoreThanOneElement	"); }
        public static Exception MoreThanOneMatch() { return new Exception("	MoreThanOneMatch	"); }
        public static Exception NotSupported() { return new Exception("	NotSupported	"); }
        public static Exception ArgumentOutOfRange(string errorMsg) { return new Exception(errorMsg); }
