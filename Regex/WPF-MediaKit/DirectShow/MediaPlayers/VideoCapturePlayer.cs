...
namespace WPFMediaKit.DirectShow.MediaPlayers
{
    ...
    public class VideoCapturePlayer : MediaPlayerBase, ISampleGrabberCB
    {
        ...
        private IAMVideoProcAmp m_videoProcAmp;
        ...
        {
            //initial cameracontrolsetter
            capGraph.FindInterface(
                PinCategory.Capture,
                MediaType.Video,
                captureFilter,
                typeof(IAMCameraControl).GUID,
                out object cameraControl);
            this.m_cameraControl = cameraControl as IAMCameraControl;
            this.CameraControlSetter = new CameraControlSetter(this.m_cameraControl);
            ...
            capGraph.FindInterface(
                ...
                MediaType.Video,
                captureFilter,
                typeof(IAMVideoProcAmp).GUID,
                out object videoProcAmp);
            this.m_videoProcAmp = videoProcAmp as IAMVideoProcAmp;
            this.VideoProcAmpSetter = new VideoProcAmpSetter(this.m_videoProcAmp);
