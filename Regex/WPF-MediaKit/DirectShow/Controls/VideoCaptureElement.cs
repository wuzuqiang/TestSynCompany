...
namespace WPFMediaKit.DirectShow.Controls
{
    ...
    public class VideoCaptureElement : MediaElementBase
    {
        ...
        #region 设置VideoProcAmp的GetParameter、GetRangeParameter、SetParameter
        /// <summary>
        ...
        /// <param name="videoProcAmpProperty"></param>
        /// <param name="propertyValue"></param>
        public void SetVideoProcAmpParameterValue(VideoProcAmpProperty videoProcAmpProperty, int propertyValue)
        {
            VideoCapturePlayer.Dispatcher.BeginInvoke((Action)delegate
            {
                VideoCapturePlayer.VideoProcAmpSetter?.SetParameterValue(videoProcAmpProperty, propertyValue);
            });
        }
        /// <summary>
        /// 设置Auto属性值
        ...
        /// <param name="videoProcAmpProperty"></param>
        /// <param name="propertyValue"></param>
        public void SetVideoProcAmpAutoParameterValue(VideoProcAmpProperty videoProcAmpProperty, int propertyValue)
        {
            VideoCapturePlayer.Dispatcher.BeginInvoke((Action)delegate
            {
                VideoCapturePlayer.VideoProcAmpSetter?.SetAutoParameterValue(videoProcAmpProperty, propertyValue);
            });
        }
        /// <summary>
        /// 设置Manual属性值
        ...
        public void CheckSupportProperty()
        {
            VideoCapturePlayer.Dispatcher.BeginInvoke((Action)delegate
            {
                VideoCapturePlayer.CameraControlSetter?.CheckSupportProperty();
            });
        }

        public void CheckSupportPropertyVideoProcAmp()
        {
            VideoCapturePlayer.Dispatcher.BeginInvoke((Action)delegate
            {
                VideoCapturePlayer.VideoProcAmpSetter?.CheckSupportProperty();
            });
        }
